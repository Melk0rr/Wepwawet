# INFO: Helper class adressing URL object behaviour
...
class URL:
    ...
    def __init__(self, url: str):
        ...
        self.geo_location = {"city": "", "country": ""}
    ...
    def set_geo_location(self, country: str, city: str):
        ...
        self.geo_location = {"city": city, "country": country}
    ...
    def to_dictionary(self) -> Dict:
        ...
        formated_ports_str = (
            ", ".join(f"{x}" for x in self.ip.get_port_strings()) if self.ip else ""
        )
        return {
            "host": self.netloc,
            "ip": self.get_ip_str(),
