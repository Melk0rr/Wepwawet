...
setup(name='wepwawet', version=__version__,
      description='URLs information gathering',
      long_description=long_description,
      long_description_content_type="text/markdown",
      url='https://github.com/JaufreLallement/Wepwawet', author='Jaufré Lallement',
      author_email='lallement.j.pro@outlook.fr',
      classifiers=['Intended Audience :: Developers',
                   'Topic :: Utilities',
                   'License :: Public Domain',
                   'Operating System :: OS Independent',
                   'Programming Language :: Python :: 3.10', ], keywords='cli',
      packages=find_packages(exclude=['docs', 'tests*']), install_requires=[reqs],
